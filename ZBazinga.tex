...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{CONTENTS/SpatialEpidemics}
\input{CONTENTS/NetworkResilience}
\input{CONTENTS/EvolvingNetworks}
\input{CONTENTS/HumanMobility}
\input{CONTENTS/DOL}
\input{CONTENTS/Physics}
\input{CONTENTS/Involution}
\input{CONTENTS/Population_Dynamics}
\input{CONTENTS/IDEA}
\input{CONTENTS/Writing}
